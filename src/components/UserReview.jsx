            ...
            <div className="container mx-auto " >
                <section className="py-3 bg-gray-100 my-5 ">
                    <div className="container flex flex-col  items-center justify-center p-4 mx-auto sm:p-10">
                        ...
                        <div className="flex flex-row flex-wrap-reverse justify-center mt-10 gap-9">
                            <div className="flex flex-col justify-center w-full px-4 mx-3 my-6 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
                                <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://i.ibb.co/v1WxbfS/user-3331256-1280.png" />
                                <div className="flex-1 my-2">
                                    <p className="text-xl font-semibold leading-snug">Sohel</p>
                                    <Slide direction={'up'}>
                            ...
                            <div className="flex flex-col justify-center w-full px-4 mx-3 my-6 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
                                ...
                                <div className="flex-1 my-4">
                                    <p className="text-xl font-semibold leading-snug">Arbaz</p>
                                    <Slide direction={'up'}>
                            ...
                            <div className="flex flex-col justify-center w-full px-4 mx-3 my-6 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
                                <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://i.ibb.co/v1WxbfS/user-3331256-1280.png" />
                                <div className="flex-1 my-2">
                                    <p className="text-xl font-semibold leading-snug">Sharna</p>
                                    <Slide direction={'up'}>
                            ...
                            <div className="flex flex-col justify-center w-full px-4 mx-3 my-6 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
                                <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://i.ibb.co/v1WxbfS/user-3331256-1280.png" />
                                <div className="flex-1 my-4">
                                    <p className="text-xl font-semibold leading-snug">Salman</p>
                                    <Slide direction={'up'}>
                                        <p>Briefly introduce the portrait you're reviewing. Mention the artist's name and any relevant background information.</p>
                                    </Slide>
                                </div>
